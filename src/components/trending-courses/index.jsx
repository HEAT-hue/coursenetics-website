...
const courses = [
  {name: 'Marketing and Sales', link: '/', bg: `${moyo}`, number: '12', duration: '8'},
  {name: 'Web Development', link: '/', number: '10', duration: '6'},
  {name: 'Virtual Assistant', link: '/', number: '8', duration: '4'}
]
    ...
    <div className="p-3 md:p-16">
      ...
      <div className="p-4 md:flex md:flex-row md:justify-between">
        {courses.map((item, idx)=> {
          return (
            <section>
            <div className="py-4 px-8 bg-[gray] rounded-lg flex flex-col justify-between h-48 md:w-[365px]">
